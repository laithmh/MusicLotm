...
class CurrentSongIndexFinder {
    ...
    try {
      ...
      if (controller.isallmusic.isTrue) {
        ...
        if (playlistController.currentPlaylistId.value.isNotEmpty) {
          foundIndex = _findIndexInList(songId, playlistController.currentPlaylistSongs);
          context = 'playlist';
        } 
  ...
  static Future<void> _savePlaybackState({
    ...
    try {
      ...
      log('💾 Saved playback state: index=$index, song=$songId, context=$context');
    } catch (e) {
