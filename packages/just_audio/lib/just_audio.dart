...
class AudioPlayer {
  ...
  late final _visualizerEventChannel =
      EventChannel('com.ryanheise.just_audio.visualizer/$_id');

  /// A 60 FPS stream of 32 normalized frequency magnitude bands [0.0, 1.0].
  Stream<List<double>> get visualizerStream => _visualizerEventChannel
